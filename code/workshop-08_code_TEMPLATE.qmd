...
slice_sample(
  drought_exp_clean, # dispalying rtows from drought_exp_clean
...
The best model that predicts total plant mass (g) includes water treatment and species (F(7, 62) = 27.08, p < 0.001, a$\alpha$ = 0.05), but not SLA.  
